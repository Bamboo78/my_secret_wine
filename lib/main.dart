...
final ValueNotifier<bool> globalThemeNotifier =
    ValueNotifier<bool>(true); // true = dark theme


Future<void> toggleGlobalTheme() async { // Función global para cambiar tema
...
Future<T?> showFadeDialog<T>({ // Función global para mostrar diálogos con transición de fade
...
class SplashScreen extends StatefulWidget { // Pantalla de bienvenida
...
class _SplashScreenState extends State<SplashScreen> { // Estado de la pantalla de bienvenida
  @override
  void initState() {
    super.initState();
  ...
  @override
  Widget build(BuildContext context) { // Construcción de la interfaz de la pantalla de bienvenida
    return Scaffold(
...
void main() async { // Función principal de la aplicación
  ...
  await SystemChrome.setPreferredOrientations([
    // Configurar orientaciones preferidas (solo vertical)
...
class MySecretWineApp extends StatefulWidget { // Widget principal de la aplicación
...
class _MySecretWineAppState extends State<MySecretWineApp> // Estado principal de la aplicación
  ...
  // Construcción del contenedor principal de la aplicación
  @override
...
class HomePage extends StatefulWidget { // Página principal de la aplicación
  final AudioPlayer audioPlayer;
...
class _HomePageState extends State<HomePage> { // Estado de la página principal
  ...
  // Función para mostrar el diálogo de advertencia de modo invitado
                                                ...
                                                onPressed: () async {
                                                  try {
                                                    final Uri url = Uri.parse(
                                                        'https://www.lachicadeamarillo.com/collections/all');
                                                    bool canLaunch =
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text('Voy a tomar una copa',
                              style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: _getTextColor())),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                                                                  ...
                                                                  try {
                                                                    ...
                                                                    final canLaunch =
                                                                        await canLaunchUrl(
                                                                            url);
                                                                    debugPrint(
                                                                        'Popup 2 - Can launch URL: $canLaunch');
                                                                    if (canLaunch) {
                                                                      ...
                                                                      debugPrint(
                                                                          'Popup 2 - URL launched: $launched');
                                                                    } else {
                                                                      debugPrint(
                                                                          'Popup 2 - Cannot launch URL, trying fallback');
                                                                      await launchUrl(
                                                                          url);
                                                                    }
                                                                  } catch (e) {
                                                                    debugPrint(
                                                                        'Popup 2 - Error launching URL: $e');
                                                                  }
                                                                },
                                                                child: Padding(
                                                                  padding: const EdgeInsets
                                                                ...
                                                                try {
                                                                  ...
                                                                  final canLaunch =
                                                                      await canLaunchUrl(
                                                                          url);
                                                                  debugPrint(
                                                                      'Popup 2 Icon - Can launch URL: $canLaunch');
                                                                  if (canLaunch) {
                                                                    final launched =
                                                                        await launchUrl(
                                                                            url,
                                                                            mode:
                                                                                LaunchMode.externalApplication);
                                                                    debugPrint(
                                                                        'Popup 2 Icon - URL launched: $launched');
                                                                  } else {
                                                                    debugPrint(
                                                                        'Popup 2 Icon - Cannot launch URL, trying fallback');
                                                                    await launchUrl(
                                                                        url);
                                                                  }
                                                                } catch (e) {
                                                                  debugPrint(
                                                                      'Popup 2 Icon - Error launching URL: $e');
                                                                }
                                                              },
                                                              child:
                                                                  CircleAvatar(
                          ...
                          child: Text('Ya soy parte del brindis',
                              style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: _getTextColor())),
...
String generateCode(String email) { // Función generador de código basado en email
...
void _showExitConfirmationDialog( // Función para mostrar diálogo de confirmación para cerrar la aplicación
    BuildContext context,
    Color Function() getBackgroundColor,
    Color Function() getTextColor,
    Color Function() getBorderColor) {
  showGeneralDialog(
    context: context,
    barrierColor: const Color.fromRGBO(0, 0, 0, 0.8),
